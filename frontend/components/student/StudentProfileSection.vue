        ...
        <div class="rounded-3xl border border-indigo-500/30 bg-gradient-to-r from-slate-950 via-indigo-950/60 to-slate-950 p-6 shadow-2xl shadow-indigo-950/40 ring-1 ring-indigo-500/20">
          <div class="flex flex-col sm:flex-row items-center justify-between gap-5">
            ...
            <button
              ...
              class="w-full sm:w-auto inline-flex items-center justify-center rounded-xl bg-gradient-to-r from-indigo-500 via-blue-600 to-emerald-500 px-6 py-3 text-xs font-black text-white shadow-xl shadow-indigo-500/25 transition-all hover:from-indigo-400 hover:to-emerald-400 active:scale-95 disabled:opacity-60 flex-shrink-0"
            >
