            ...
            <table class="min-w-full divide-y divide-white/10">
              ...
              <tbody class="bg-slate-900/80 divide-y divide-white/10">
                <tr v-for="job in paginatedBusinessJobs" :key="job.id" class="hover:bg-white/5 transition-colors">
                  ...
                  <td class="px-6 py-4 whitespace-nowrap text-right text-xs space-x-1.5">
                    <button
                      @click="handleEditJob(job)"
                      title="Chỉnh sửa bài đăng"
                      class="p-2 inline-flex items-center justify-center bg-cyan-500/10 hover:bg-cyan-500/20 text-cyan-300 border border-cyan-500/30 rounded-xl transition-all shadow-sm hover:scale-105"
                    >
                    ...
                    <button
                      ...
                      class="p-2 inline-flex items-center justify-center bg-rose-500/10 hover:bg-rose-500/20 text-rose-400 border border-rose-500/30 rounded-xl transition-all shadow-sm hover:scale-105"
                    >
                      <svg class="h-4 w-4" fill="none" viewBox="0 0 24 24" stroke="currentColor" stroke-width="2">
